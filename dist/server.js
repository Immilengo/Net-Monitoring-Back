...
var AlertEngineService = class {
  ...
  async handleDeviceStatusChange(device, newStatus) {
    try {
      if (newStatus === import_client12.MonitoringStatus.OFFLINE) {
      ...
      if (newStatus === import_client12.MonitoringStatus.ONLINE) {
...
var MonitoringCheckService = class {
  ...
  async checkDevice(device) {
    try {
      ...
      const newStatus = result.reachable ? import_client13.MonitoringStatus.ONLINE : import_client13.MonitoringStatus.OFFLINE;
